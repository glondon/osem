class Role < ActiveRecord::Base
  ...
  TAGS = {'name' => 'Attendee', 'description' => 'For the attendees of the conference'},
  ...
  ROLES = {'name' => 'Organizer', 'description' => 'For the organizers of the conference (who shall have full access)'},
